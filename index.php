...
/* Optional: Add additional styling for focus state */
.button:focus {
  outline: none;
  box-shadow: 0 0 0 3px rgba(0, 123, 255, 0.4); /* Example focus border */
}
...
<body>
	...
	<div class="main-wthree" >
		<div class="container">
			<p class="text-center text-white">Human Resource Management System</p><br><br>
...
<br><br>
					<div style="float:left">
						<button value="Back" class="button"><a href="index.html">Back</a></button>
						</div>
					<div class="footer">
