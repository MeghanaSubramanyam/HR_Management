...
<?php
	...
	if(isset($_GET['employeeid']))
	{
		...
		$login=mysqli_query($db,"SELECT LastLogIn from employee where EmpId='$empid'");
		$login_time=mysqli_fetch_assoc($login);

		$logout=mysqli_query($db,"SELECT LastLogout from employee where EmpId='$empid'");
		$logout_time=mysqli_fetch_assoc($logout);
	...
	<div class="row">
		...
		<div class="col-md-3">
			<table>
				...
				<tbody>
					<tr>
						<td style="text-align: right;"><b>Log in</b> ::</td>
						<td><?php
								echo implode('-',$login_time);
				...
				<tbody>
					<tr>
						<td style="text-align: right;"><b>Log Out</b> ::</td>
						<td><?php
							echo implode('-',$logout_time);
								?></td>
					</tr>
				</tbody>
