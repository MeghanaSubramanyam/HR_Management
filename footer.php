						...
						<div style="border-top:1px ridge rgba(255, 255, 255, 0.15)"></div>
                           <div class="menu">
									<ul id="menu" >
										...
										<li><a href="#"><i class="fa fa-user"></i><span>Employee</span><span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
											<ul>
												...
												<li><a href="employeeview.php">Employee View</a></li>
												 <li><a href="atten.php">Working Hours</a></li>
												<!-- <li><a href="projectview.php">Project Details</a></li>  -->
												<!-- <li><a href="inquiry.php">Inquiry</a></li> -->
											</ul>
										</li>
										<li><a href="#"><i class="fa fa-book"></i><span>Projects</span><span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
											<ul>
												 <!-- <li><a href="employeeadd.php">Add Employee</a></li>
												<li><a href="employeeview.php">/a></li> -->
										...
										<!-- <li><a href="#"><i class="fa fa-user"></i><span>Projects</span><span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
												<ul>
													<li><a href="projectupdate.php">Project Update</li>
												</ul></li> -->
