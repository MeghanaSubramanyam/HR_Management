	...
	if(isset($_POST['submit']))
	{
		...
		if($ImageComplete)
		{
			...
			if($editid==0)
			{
				...
				mysqli_query($db,"insert into employee values(null,'$empid','$fname','$mname','$lname','$bdate','$gender','$address1','$address2','$address3','$city','$mnumber','$email','$password',null,'$marital','$position','$roleid','$datetime',null,null,'$joindate','$leavedate',null,null,'$status','$role',null,null,null,null)");
